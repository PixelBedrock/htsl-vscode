...
function readActions(actionType: string, actionData: any): string {
    let line = "";
...
export function activate(context: vscode.ExtensionContext) {
    ...
    const convertEditorAction = vscode.commands.registerCommand('htsl-vscode.convertEditorAction', async () => {
    ...
    context.subscriptions.push(convertEditorAction);
}
